...
public class CreateTeamGUI extends JFrame {
    ...
    private void onClickConfirm(User user){
        ...
        try {
            ...
            team.setCodigo(FormatHelper.generateCodigoTurma(inputName.getText()));
            try {
                Team persistedTeam = teamService.createTeam(team, (Teacher) user);
                JOptionPane.showMessageDialog(null, "Turma cadastrada com sucesso!" + "Código: " + persistedTeam.getCodigo() );
            } catch (Exception ex) {
